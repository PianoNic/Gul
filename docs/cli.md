...
- **Redirects aren't followed.** The CLI forwards your app's `3xx` responses as-is, so the visitor's browser sees them - relative redirects keep working through the public URL.
...
See also: [Self-host Gul](./self-host.md) · [What is Gul?](./intro.md)
